...
import logo from "./searchimg.jpg";
import logo1 from "./sun.jpg";
import logo2 from "./humidity.jpg";
import logo3 from "./wind.jpg";
import logo4 from "./clear.jpg";
import logo5 from "./Rain.jpg";
import logo6 from "./Drizzle.jpg";
import logo7 from "./mist.jpg";
import logo8 from "./Snow.jpg";
...
function App() {
  ...
  const handleClick = () => {
    if(name !== "") {
      const apiUrl = `https://api.openweathermap.org/data/2.5/weather?q=${name}&appid=6775f6d06e3b835ef35fdd5d385985e8&units=metric`;
      axios.get(apiUrl)
      .then(res => {
